...
const faqs = [
  ...
  },
  {
    ...
    question: 'How is the rental day calculated?',
    answer: 'Each rental day is exactly 24 hours from your pickup time. For example, if you collect the car at 10:00 AM, it must be returned by 10:00 AM the following day. Returning the vehicle even one hour beyond your agreed time will be charged as a full additional day.',
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5" aria-hidden>
